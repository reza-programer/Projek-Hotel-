    ...
    <div class="auth-container">
      <div class="auth-card card-shoji">
        ...
        <div class="auth-header">
          ...
          <h1 class="auth-title">Lupa Sandi?</h1>
          <p class="auth-subtitle">Masukkan email Anda untuk menerima tautan reset kata sandi.</p>
        </div>
...
const handleSubmit = () => {
  ...
  form.post('/forgot-password', {
    onSuccess: () => {
      successMessage.value = 'Tautan reset kata sandi telah dikirim ke email Anda.'
      loading.value = false
    },
    onError: (errors) => {
      errorMessage.value = errors.email || 'Terjadi kesalahan. Silakan coba lagi.'
      loading.value = false
    }
  })
}
